# /dotnet6-modern - .NET 6+ モダン開発専用コマンド

## 概要
.NET 6以降の最新機能を活用したモダンアプリケーション開発に特化した包括的な最適化コマンドです。Minimal API、Hot Reload、Global Using、Source Generators、Native AOT、パフォーマンス最適化を完全サポートします。
...
## 管理責任
- **管理部門**: システム開発部
- **専門性**: .NET 6+ モダン開発、Native AOT、高性能API

---
*このコマンドは.NET 6以降のモダン開発に特化しています。*