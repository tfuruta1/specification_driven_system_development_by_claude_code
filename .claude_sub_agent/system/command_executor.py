...
class CommandExecutor:
    ...
    def spec_init(self):
        ...
        # ディレクトリ構造を作成
        dirs = [
            ".claude_sub_agent/.ActivityReport/tasks",
            ".claude_sub_agent/.ActivityReport/daily_report",
            ".claude_sub_agent/.ActivityReport/daily_log",
            ".claude_sub_agent/docs/requirements",
            ".claude_sub_agent/docs/design",
            ".claude_sub_agent/docs/tasks",
            "src/api",
            "src/models",
            "src/services",
            "src/tests"
...
"""
        ...
        # shared_tasks.md作成
        tasks_file = Path(".claude_sub_agent/.ActivityReport/tasks/shared_tasks.md")
...
"""
        ...
        req_file = Path(f".claude_sub_agent/docs/requirements/requirements_{datetime.now().strftime('%Y%m%d')}.md")
...
"""
        ...
        design_file = Path(f".claude_sub_agent/docs/design/design_{datetime.now().strftime('%Y%m%d')}.md")
...
"""
        ...
        tasks_file = Path(f".claude_sub_agent/docs/tasks/tasks_{datetime.now().strftime('%Y%m%d')}.md")
...
'''
    ...
    def spec_status(self):
        ...
        phases = {
            ...
            "要件定義": any(Path(".claude_sub_agent/docs/requirements").glob("*.md")),
            "技術設計": any(Path(".claude_sub_agent/docs/design").glob("*.md")),
            "タスク分割": any(Path(".claude_sub_agent/docs/tasks").glob("*.md")),
...
"""
        ...
        cache_dir = Path(".claude_sub_agent/cache")
