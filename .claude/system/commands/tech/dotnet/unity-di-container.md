# /unity-di-container - Unity DI/IoC„Ç>=„É>=„ÉÜ„ÉäÂ∞ÇÁî(R)„Ç>=„Éû„É>=„Éâ

## Ê¶ÇË¶Å
Unity ContainerÔºà.NET FrameworkÔºâ„Å(R).NETÊ(R)ôÊ∫ñDI/IoC„Ç>=„É>=„ÉÜ„Éä„ÅÆ‰∏°Êñπ„Å´ÂØæÂøú„Åó„Åü‰æùÂ!=òÊÄßÊ>=(R)ÂÖ•ÂÆüËGBPÖ„ÅÆÂ∞ÇÁî(R)„Ç>=„Éû„É>=„Éâ„Åß„Åô„ÄÇ„É¨„Ç¨„Ç∑„Éº„Ç∑„Çπ„ÉÜ„É†„Åã„Çâ„É¢„ÉÄ„É>=DI„Ç>=„É>=„ÉÜ„Éä„Å∏„ÅÆÁßªË°å„ÄÅ‰ºÅÊ•!=„É¨„Éô„É´„ÅÆDI„Éë„Çø„Éº„É>=„ÄÅAOP„ÄÅ„É(C)„Ç§„Éï„Çµ„Ç§„ÇØ„É´ÁÆ°ÁêÜ„ÇíÂåÖÊã¨ÁöÑ„Å´„Çµ„Éù„Éº„Éà„Åó„Åæ„Åô„ÄÇ

## „Éê„Éº„Ç∏„Éß„É>=Ê§úÂá∫„Å(R)Ëá(TM)ÂãïÈÅ∏Êäû
```csharp
...
## Unity ContainerÂÆüËGBPÖÔºà.NET FrameworkÔºâ

### 1. Unity Container „Ç(R)„É>=„Çø„Éº„Éó„É(C)„Ç§„Ç∫Ë(R)!=ÂÆö
```csharp
...
### 2. AOPÔºàAspect-Oriented ProgrammingÔºâÂÆüËGBPÖ
```csharp
...
### 2. Decorator Pattern „Å(R)ProxyÂÆüËGBPÖ
```csharp
...
### 3. È´òÂ∫¶„Å(TM)„É(C)„Ç§„Éï„Çµ„Ç§„ÇØ„É´ÁÆ°ÁêÜ
```csharp
...
## „Éê„Éº„Ç∏„Éß„É>=Âà•DIÊ(C)üËÉΩÂØæÂøúË°(R)

| Ê(C)üËÉΩ | .NET 6+ Built-in | Autofac | Unity Container | .NET Framework DI |
|------|------------------|---------|-----------------|-------------------|
...
| Decoration | SYSTEMüì¶ Scrutor | ‚úÖ | ‚úÖ | ‚ùå |
| Assembly Scanning | üì¶ Scrutor | ‚úÖ | ‚úÖ | ‚ùå |
| Lifetime Management | ‚úÖ Basic | ‚úÖ Advanced | ‚úÖ Advanced | ‚ùå |

## Âá∫Âäõ„É¨„Éù„Éº„Éà
```markdown
# Unity DI/IoC„Ç>=„É>=„ÉÜ„ÉäÊúÄÈÅ(C)Âåñ„É¨„Éù„Éº„Éà

## ÂÆüÊñΩÈ†ÖÁõÆ
‚úÖ Unity Container: ÂÆåÂÖ(R)Ë(R)!=ÂÆö
‚úÖ AOPÂÆüËGBPÖ: InterceptionÂØæÂøú
‚úÖ „É¢„ÉÄ„É>=DIÁßªË°å: AutofacÁµ+/-Âêà
‚úÖ Decorator Pattern: ÂÆüËGBPÖÂÆå‰∫Ü
‚úÖ „É(C)„Ç§„Éï„Çµ„Ç§„ÇØ„É´ÁÆ°ÁêÜ: Ëá(TM)ÂãïÂåñ

## „Éë„Éï„Ç(C)„Éº„Éû„É>=„ÇπÊåáÊ(R)ô
- ‰æùÂ!=òËßGBPÊ+/-∫ÊôÇÈñì: <1ms
- „É°„É¢„É(TM)‰ΩøÁî(R)Èáè: Âü∫Ê∫ñÊØî20%ÂâäÊ∏õ
- AOP „Ç(TM)„Éº„Éê„Éº„Éò„ÉÉ„Éâ: <5%
- Ë(R)!=ÂÆöË(TM)!=„ÅøËæº„Åø: 50ms

## ÁßªË°åÂäπÊûú
- „É¨„Ç¨„Ç∑„Éº„Ç>=„Éº„Éâ: Unity ‚Üí .NET DI
- „ÉÜ„Çπ„Çø„Éì„É(TM)„ÉÜ„ÇGBP: 300%Âêë‰∏ä
- ÁµêÂêàÂ∫¶: 70%ÂâäÊ∏õ
- ‰øùÂÆàÊÄß: 200%Âêë‰∏ä

## Êé(R)Â•(R)‰∫ãÈ†Ö
1. .NET 6+„Å∏„ÅÆÊÆµÈöéÁöÑÁßªË°å
2. AutofacÊé°Áî(R)Ê§úË(R)é
3. AOPÊJPYªÁî(R)Êã°Â§ß
4. Âçò‰Ωì„ÉÜ„Çπ„ÉàÂº∑Âåñ
```

## ÁÆ°ÁêÜË<=¨‰ªª
- **ÁÆ°ÁêÜÈÉ(R)ÈñÄ**: „Ç∑„Çπ„ÉÜ„É†ÈñãÁô∫ÈÉ(R)
- **Â∞ÇÈñÄÊÄß**: ‰æùÂ!=òÊÄßÊ>=(R)ÂÖ•„ÉªIoCË(R)!=Ë(R)à„Éë„Çø„Éº„É>=

---
*„Åì„ÅÆ„Ç>=„Éû„É>=„Éâ„ÅØUnity Container„Å(R)„É¢„ÉÄ„É>=DI/IoC„Ç>=„É>=„ÉÜ„Éä„ÅÆÂÆüËGBPÖ„Å´ÁâπÂåñ„Åó„Å¶„ÅÑ„Åæ„Åô„ÄÇ*