...
> **📋 このドキュメントについて**  
> このドキュメントはVue.js + Supabaseプロジェクト用の汎用テンプレートです。  
> 新しいプロジェクトを開始する際に、このテンプレートをコピーして  
> 各セクションをプロジェクト固有の内容に置き換えてご利用ください。
...
> **🎯 次のステップ**  
> このドキュメントを完成させたら、[技術スタックガイドライン](./02_tech_stack_guidelines.md) で技術的な詳細を固めましょう。