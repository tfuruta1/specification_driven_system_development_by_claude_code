...
namespace ResultForCSharp
{
	...
	public class DocumentResult
	{
		...
		/// フィールド情報
		/// </summary>
		private FieldForDocResult [] fieldInfoes_ = null;
		...
		public DocumentResult(object obj)
		{
			if(obj == null)
			{
				return;
		...
		/// フィールド情報
		/// </summary>
		public FieldForDocResult []  FieldInfoes
		{
			get
			{
				return fieldInfoes_;
